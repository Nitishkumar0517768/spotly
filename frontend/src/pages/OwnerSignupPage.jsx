      ...
      <div className="flex-grow flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 lg:w-2/5 flex flex-col justify-center px-8 md:px-12 lg:px-16 py-4 overflow-y-auto">
          <div className="max-w-md w-full mx-auto">
            <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Create your Owner Account</h1>
            <p className="text-gray-500 mb-6 text-sm">Join Spotly and list your parking spot in seconds.</p>
